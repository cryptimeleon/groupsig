...
import de.upb.crypto.craco.groupsig.CPY06.issuing_protocol.CPY06IssuingProtocol;
import de.upb.crypto.craco.groupsig.CPY06.issuing_protocol.CPY06IssuingProtocolUserInstance;
import de.upb.crypto.craco.groupsig.common.OpenResult;
import de.upb.crypto.craco.groupsig.interfaces.*;
...
public class CPY06SignatureScheme implements GroupSignatureScheme {
    ...
    private Zp.ZpElement hash(PlainText message, GroupElement T1, GroupElement T2, GroupElement T3, GroupElement T4,
        ...
        return pp.getHashFunction().hashIntoStructure(accumulator.extractBytes());
    }
}
